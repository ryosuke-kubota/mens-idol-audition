...
const Entry = () => {
  ...
  return (
    <section id="entry" className="relative py-32 bg-transparent overflow-hidden" ref={ref}>
      <motion.div
      ...
      >
        ...
        >
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-auto shadow-xl">
            ...
            <p className="text-xl text-gray-700 font-bold" style={{ fontFamily: 'Noto Sans JP, sans-serif' }}>
        ...
        >
          <p className="text-2xl font-bold text-gray-800" style={{ fontFamily: 'Noto Sans JP, sans-serif' }}>
            OWN YOUR NEW WORLD
          </p>
        </motion.div>
